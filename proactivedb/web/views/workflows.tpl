<div id="page-main" class="container">
            ...
            <form class="form-horizontal" role="form" id="workflow-form" name="workflow-form">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        ...
                        <div class="form-group">
                            <label for="workflow.sets" class="col-sm-2 control-label">Sets</label>
                            <div class="col-sm-10">
                                <select class="form-control input-sm" multiple="true" name="workflow.sets" id="workflow.sets"></select>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="row">
        <div id="test-workflow-form" class="col-lg-12 col-md-12" style="display:none">

...
$(document).ready(function() {
    ...
    $('#selectWorkflowsDropdown').on('hidden.bs.dropdown', function() {
        $("#i_dropdown").removeClass("glyphicon-minus");
        $("#i_dropdown").addClass("glyphicon-plus");
    });

    $('#selectWorkflowsDropdown').on('shown.bs.dropdown', function() {
        $("#i_dropdown").removeClass("glyphicon-plus");
        $("#i_dropdown").addClass("glyphicon-minus");
    });
    ...
    if (workflows) {
        ...
        for (var i = 0; i < workflows.length; i++){
            ...
            // convert spaces in workflow name to underscores
            checkbox = checkbox.replace(/ /g, '_');
